...
description: 'Upgrade your application from mcp-ts v1.x to v2.0.0: the new sessions API, useMcp userId rename, and required SQL storage backend schema migrations.'
---
