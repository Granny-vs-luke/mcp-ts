...
description: 'Upgrade your application from mcp-ts v1.x to v2.0: rename storage to sessions, switch identity to userId, and apply database schema migrations.'
---
