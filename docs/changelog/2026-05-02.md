---
title: "May 2, 2026"
description: "v1.6.0 — Server-scoped tool search, new mcp_list_servers diagnostic, and published ToolRouter benchmarks."
---
...
When a temporal or current-information query (e.g. "latest news", "today's weather") returns no direct BM25 matches, the router now automatically retries with generic web/search/browser terms so connected web-search tools surface instead of falling silent.
