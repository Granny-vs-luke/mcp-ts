...
The session and client APIs have been aligned around consistent naming. Highlights:
...
The tool approval flow has been refined so apps using [React](/react) or [Vue](/vue) hooks receive a more consistent approval payload. Annotation fields have been removed from tool definitions to simplify the [tool types](/reference/types).
