  ...
  <Steps>
    <Step title="Intelligent Tool Routing">
      ...
      <Frame className="mt-6">
        <video controls playsInline muted preload="metadata" className="w-full rounded-lg" src="/videos/toolrouter.mp4"></video>
      </Frame>
    </Step>
    ...
    <Step title="Next.js Client Walkthrough">
      ...
      <Frame className="mt-6">
        <video controls playsInline muted preload="metadata" className="w-full rounded-lg" src="/videos/mcp-ts.mp4"></video>
      </Frame>
    </Step>
    ...
    <Step title="Render MCP Apps">
      ...
      <Frame className="mt-6">
        <video controls playsInline muted preload="metadata" className="w-full rounded-lg" src="/videos/mcp-apps-ext.mp4"></video>
      </Frame>
    </Step>
    ...
    <Step title="Cross-Runtime Agents using AGUI Protocol">
      ...
      <Frame className="mt-6">
        <video controls playsInline muted preload="metadata" className="w-full rounded-lg" src="/videos/langchain-agui.mp4"></video>
      </Frame>
    </Step>
  </Steps>
