...
Middleware layer for intelligent MCP tool selection to optimize context window usage. Instead of injecting all tools at once, you can let the LLM discover and load tools on-demand using BM25 or semantic search.
